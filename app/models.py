    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["item_id", "tag_id"], name="item_tag_unique"
            ),
        ]
...
class Matching(models.Model):
    seller = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="seller_user"
    )
...
class Review(models.Model):
    ...
    evaluator = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="evaluator_user"
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["rater", "evaluator"],
                name="rater_evaluator_unique",
            ),
        ]

    def __str__(self):
        return f"{self.rater} {self.score}"
